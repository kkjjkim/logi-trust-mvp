import { User, Role, Place, Constraint, ConstraintStatus, EditRequest, RequestStatus, Review, PlaceVersion, Notification } from '../types';

export const MOCK_USERS: User[] = [
  { id: 'u1', role: Role.DRIVER, name: '김기사' },
  { id: 'u2', role: Role.DRIVER, name: '박화물' },
  { id: 'u3', role: Role.MANAGER, name: '이담당' },
  { id: 'ops1', role: Role.OPS, name: '최운영' },
];

export const MOCK_IMAGES = [
  "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=800&q=80", // Warehouse interior
  "https://images.unsplash.com/photo-1595246140625-573b715e11d3?w=800&q=80", // Loading dock
  "https://images.unsplash.com/photo-1621929747188-0b4dc28498d2?w=800&q=80", // Forklift
  "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=800&q=80", // Truck entrance
  "https://images.unsplash.com/photo-1580674684081-7617fbf3d745?w=800&q=80", // Gate
  "https://images.unsplash.com/photo-1532635241-17e820acc59f?w=800&q=80", // High rack
  "https://images.unsplash.com/photo-1494412574643-35d324698420?w=800&q=80", // Port
  "https://images.unsplash.com/photo-1565891741441-64926e441838?w=800&q=80", // Container
  "https://images.unsplash.com/photo-1578575437130-527eed3abbec?w=800&q=80", // Pallets
  "https://images.unsplash.com/photo-1616432043562-3671ea2e5242?w=800&q=80"  // Safety sign
];
...
export const MOCK_REQUESTS: EditRequest[] = [
  ...
  // 2 DISPUTED Simulation (Same place, Same field, Different Values)
  {
  ...
  // 2 Approved
  {
    ...
    currentValue: '없음', requestedValue: '도크 3개 증설', requestedBy: 'u3', requestedByName: '이담당', requestedByRole: Role.MANAGER,
